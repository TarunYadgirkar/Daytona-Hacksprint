...
Also read `CLAUDE.md` for the time-boxed working-style rules that are not duplicated here. If the files conflict, this `AGENTS.md` takes precedence for Codex.
